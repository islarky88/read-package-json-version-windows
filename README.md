...
This GitHub Action (written in JavaScript) wraps the [GitHub Release API](https://developer.github.com/v3/repos/releases/), specifically the [Create a Release](https://developer.github.com/v3/repos/releases/#create-a-release) endpoint, to allow you to leverage GitHub Actions to read package.json version windowss.

<a href="https://github.com/islarky88/read-package-json-version-windows"><img alt="GitHub Actions status" src="https://github.com/islarky88/read-package-json-version-windows/workflows/Tests/badge.svg"></a>
...
#### `body_path`
The `body_path` is valuable for dynamically creating a `.md` within code commits and even within the Github Action steps leading up to the `read-package-json-version-windows`.
...
jobs:
  build:
    ...
    steps:
      ...
      - name: read package.json version windows
        id: create_release
        uses: islarky88/read-package-json-version-windows@v1
        env:
...
## Contributing
We would love you to contribute to `@islarky88/read-package-json-version-windows`, pull requests are welcome! Please see the [CONTRIBUTING.md](CONTRIBUTING.md) for more information.
