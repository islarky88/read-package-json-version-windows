...
const fs = require('fs');
const run = require('../src/read-package-json-version-windows.js');

/* eslint-disable no-undef */
describe('read package.json version windows', () => {
  let createRelease;
  ...
  test('read package.json version windows endpoint is called', async () => {
    core.getInput = jest
      .fn()
